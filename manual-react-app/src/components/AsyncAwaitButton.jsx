...
// Async/await using service
const fetchUserAsyncAwait = async () => {
    const result = await fetchRandomUser('asyncawait');
    return result;
};
...
export default AsyncAwaitButton;
